        ...
        .get({
              ...
              success: function(res) {
                ...
                if (res.data.length == 0) { //判断用户名是否被注册过，等于空说明没被查询到，就是没有注册过，
                  ...
                  db.collection('root').where({ //我写的数用户名和手机号都可以登录，所以同一个手机号和用户名只能算一个账号，也要验证一下手机号是否被注册过
                    ...
                    .get({
                      ...
                      success: function(res) {
                        ...
                        if (res.data.length == 0) { //判断手机号是否被注册过，等于空说明没被查询到，就是没有注册过，
                          ...
                          db.collection('root').add({ //验证完成之后，添加的接口
