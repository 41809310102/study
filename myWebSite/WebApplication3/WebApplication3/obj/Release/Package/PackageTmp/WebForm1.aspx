   ...
   <header> 
       <div class="content">
            ...
            <div class='ribbon'>
                ...
                <a href='./form.html'><span>资料</span></a>
                  <a href='./form.html'><span>设计</span></a>
    ...
    <aside style="height: 351px">
        <div class="from">
        <div class="submit">
            <span class="form_title">个人信息验证</span>
           
            <div class="btn_submit">
                <a href="./denlu.aspx">
                    <button class="btn">账号登录</button></a>
                <a href="./zhuce.aspx" class="back"><button class="home_href">注册</button></a>
            </div>
        </div>
    </div>
        </aside>
              <img class="bgunder" src="./img/under.jpg" alt=""/></div>
    </footer>
