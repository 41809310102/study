		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<dic class="shop_home_form">
					<form action="${pageContext.request.contextPath}/privilege/privilegeServlet?method=addressUpdate"class="shop_form" method="post">
						<ul>
						  <li><input type="hidden" value="${address.did}" name="did"> </li>
							<li><label><span>*</span>收货人姓名：</label><input type="text" class="form-text" name="name" value="${address.name }" /></li>
							<li><label><span>*</span>所在地：</label><input type="text" class="form-text" value="中国" /></li>
							<li><label><span>*</span>省：</label><input type="text" value="${address.province }" name="province"></li>
							<li><label><span>*</span>市：</label><input type="text" value="${address.city }" name="city"></li>
							<li><label><span>*</span>区：</label><input type="text" value="${address.area }" name="area"></li>
							<li><label><span>*</span>详细地址：</label><input type="text" value="${address.address }" name="address"></li>
							<li><label>邮编：</label><input type="text" class="form-text" value="${address.code }" name="code" /></li>
							<li><label>电话：</label><input type="text" class="form-text" value="${address.phone}"  name="phone" /></li>
							<li><label>手机号：</label><input type="text" class="form-text" value="${address.telephone }" name="telephone" /></li>
