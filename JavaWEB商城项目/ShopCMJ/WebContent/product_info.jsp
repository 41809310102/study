	...
	<div class="shop_goods_bd clear">
		...
		<div class="shop_goods_show">
			<div class="shop_goods_show_left">
				...
				<div id="preview">
					<div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="${product.pimage }" jqimg="${product.pimage }" width="350">
						</div>
						<div id="spec-n5">
			...
			<div class="shop_goods_show_right">
				<ul>
					...
					<li class="goods_num">
						<label>购买数量：</label>
						<span><a class="good_num_jian" id="good_num_jian" href="javascript:void(0);"></a><input type="text" value="1" id="good_nums" class="good_nums" /><a href="javascript:void(0);" id="good_num_jia" class="good_num_jia"></a>(当前库存${product.pnumber }件)</span>
					</li>
					<li style="padding:20px 0;">
						<label>&nbsp;</label>
						<span><a href="javascript:void(0)" onclick="addCart()" class="goods_sub goods_sub_gou" >加入购物车</a></span>
					</li>
				</ul>
			</div>
		</div>
		...
		function addCart(){
			...
			location.href="${pageContext.request.contextPath}/productServlet?method=cartAdd&pid=${product.pid}&buynum="+buynum;
		}
