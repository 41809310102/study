	...
	<div class="shop_member_bd clearfix">
		...
		<div class="shop_member_bd_left clearfix">
			...
			<dl>
				...
				<dd><span><a href="${pageContext.request.contextPath }/password_eidt.html">密码修改</a></span></dd>
		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<dic class="shop_home_form">
					<form action="${pageContext.request.contextPath}/PersonInfoServlet?method=update" class="shop_form" method="post">
						<ul>
							<li><label>用户名称：</label>${user.username}</li>
							<li><label>电子邮件：</label>${user.email }</li>
							<li><label>真实姓名：</label><input type="text" class="truename form-text" value="${user.name }" name="name"/></li>
							<li><label>性别:</label>
