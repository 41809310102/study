			...
			<div class="shop_bd_shdz clearfix">
				<div class="shop_bd_shdz_lists clearfix">
					...
					<c:forEach items="${list }" var="address">
						...
						<li><label><span><input type="radio" name="shdz" /></span></label><em>${address.province}</em><em>${address.city }市</em><em>${address.area}区</em><em>${address.address }</em><em>${address.name }(收)</em><em>${address.telephone }</em><span class="admin_shdz_btn"><a href="${pageContext.request.contextPath}/privilege/privilegeServlet?method=manageAddressEdit&did=${address.did}">编辑</a><a href="${pageContext.request.contextPath}/privilege/privilegeServlet?method=addressDelete&did=${address.did}">删除</a></span></li>
